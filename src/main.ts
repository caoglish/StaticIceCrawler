...
(async () => {
	makeFolder(csvFolder);
	archiveCsvFiles();
	await crawl(aVidiaCompanyList, nVidiaList, nVidiaVerifyFun,'nVidia20Result');
	await crawl(aVidiaCompanyList, nVidia300List, nVidiaVerifyFun,'nVidia30Result');
	await crawl(AMDCompnayList, AMDList, AmdVerifyFun, 'AMD5xResult');
	await crawl(AMDCompnayList, AMD6xList, AmdVerifyFun, 'AMD6xResult');
})();